...
import WidgetItemPlus from './WidgetItemPlus.vue';
import Widget from './icons/Widget.vue';
...
<template>
	<div id="main-div" :class="store.settings.position">
		...
		/>
		<WidgetItemPlus
			:index="store.settings.listMessengers.length"
			:isShow="isShow"
			:position="store.settings.position"
		/>
	</div>
